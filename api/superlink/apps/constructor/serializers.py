...
class ConstructorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Constructor
        fields = ['id', 'title', 'partner', 'components_total', 'components']
...
class ConstructorListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Constructor
        fields = ['id', 'title', 'partner', 'user', 'components_total', 'components', 'created_at']
...
class ConstructorCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Constructor
        fields = ['title', 'partner', 'components_total', 'components', 'user']
